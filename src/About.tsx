    ...
    return (
        <>
            ...
            >
                ...
                <h2 className='text-lg font-mono mb-15 ml-25 border-l-8 border-red-500 pl-5'>I love to develop not just beautiful but also functional and helpful websites or web application, 
                that's why I always give my all <br />
                in every projects i work and keep on learning everyday. </h2>
                <br />
                <h1 className='ml-25 text-3xl font-serif'>Skills</h1>
                <br />
                <div className='flex justify-center mb-20'>
                    <div className='grid grid-cols-4 gap-20 mx-auto ml-40'>
                        <div>
                ...
                <h1 className='ml-25 mb-10 text-3xl font-serif'>Work Experience</h1>
                <div className='mb-20 font-mono ml-40'>
                    ...
                    <hr className="border-t-2 border-dashed border-gray-400 my-4 mr-40" />
                ...
                <h1 className='ml-25 mb-10 text-3xl font-serif'>Certificates</h1>
                <ul className='ml-40 font-mono mb-20 space-y-5'>
                    ...
                    <a 
                        ...
                        https://www.freecodecamp.org/certification/MickeyPaulo/responsive-web-design
                    </a>
                </ul>
                <hr className="border-t-2 border-dashed border-gray-400 my-4 ml-40 mr-40" />
                <ul className='ml-40 font-mono mb-20 space-y-5'>
                    ...
                    <a 
                        ...
                        className='text-black hover:text-blue-500'>
                        https://www.freecodecamp.org/certification/MickeyPaulo/javascript-algorithms-and-data-structures-v8
                    </a>
                </ul>
                <hr className="border-t-2 border-dashed border-gray-400 my-4 ml-40 mr-40" />
                <ul className='ml-40 font-mono mb-20 space-y-5'>
                    ...
                    <a 
                        ...
                        className='text-black hover:text-blue-500'>
                        https://www.freecodecamp.org/certification/MickeyPaulo/front-end-development-libraries
                    </a>
                </ul>
                <hr className="border-t-2 border-dashed border-gray-400 my-4 ml-40 mr-40" />
                <ul className='ml-40 font-mono mb-20 space-y-5'>
                    ...
                    <a 
                        ...
                        className='text-black hover:text-blue-500'>
                        https://www.life-global.org/certificate/90ce0a0c-b5b3-44e8-b86b-4ba3e8247139
                    </a>
                </ul>
            </div>
        </>
